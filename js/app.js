...
const GAMES_DATA = [["Alien: Isolation", 17.7, "👻 Terror", 2019, "Terror", "#880000"], ["Among Us", 0.6, "🎉 Party", 2020, "Party", "#ffcc00"], ["Animal Crossing: New Horizons", 10.9, "🌱 Simulación", 2020, "Simulación", "#00ffcc"], ["Apex Legends", 27.0, "🔫 Shooter", 2021, "Shooter", "#4da6ff"], ["Arms", 2.2, "🥊 Pelea", 2017, "Pelea", "#ff4d4d"], ["Assassin's Creed IV: Black Flag", 11.8, "🗺️ Aventura", 2019, "Aventura", "#4dff88"], ["Assassin's Creed: The Ezio Collection", 35.0, "🗺️ Aventura", 2022, "Aventura", "#4dff88"], ["Astral Chain", 9.6, "💥 Acción", 2019, "Acción", "#ffaa4d"], ["Batman: Arkham Trilogy", 45.0, "🗺️ Aventura", 2023, "Aventura", "#4dff88"], ["Bayonetta 2", 12.4, "💥 Acción", 2018, "Acción", "#ffaa4d"], ["Bayonetta 3", 15.0, "💥 Acción", 2022, "Acción", "#ffaa4d"], ["Bioshock: The Collection", 31.0, "🔫 Shooter", 2020, "Shooter", "#4da6ff"], ["Borderlands Legendary Collection", 48.0, "🔫 Shooter", 2020, "Shooter", "#4da6ff"], ["Castlevania Anniversary Collection", 0.6, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"], ["Celeste", 1.2, "🏃 Plataformas", 2018, "Plataformas", "#ff4da6"], ["Clubhouse Games: 51 Worldwide Classics", 2.1, "🎉 Party", 2020, "Party", "#ffcc00"], ["Contra Anniversary Collection", 0.4, "🔫 Shooter", 2019, "Shooter", "#4da6ff"], ["Crash Bandicoot N. Sane Trilogy", 5.2, "🏃 Plataformas", 2018, "Plataformas", "#ff4da6"], ["Cult of the Lamb", 1.5, "💀 Roguelike", 2022, "Roguelike", "#884400"], ["Cuphead", 3.3, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"], ["Dark Souls Remastered", 3.9, "⚔️ RPG", 2018, "RPG", "#a64dff"], ["Dead Cells", 2.1, "💀 Roguelike", 2018, "Roguelike", "#884400"], ["Demon Slayer: The Hinokami Chronicles", 9.0, "🥊 Pelea", 2022, "Pelea", "#ff4d4d"], ["Donkey Kong Country: Tropical Freeze", 6.6, "🏃 Plataformas", 2018, "Plataformas", "#ff4da6"], ["Doom (2016)", 22.0, "🔫 Shooter", 2017, "Shooter", "#4da6ff"], ["Doom Eternal", 33.0, "🔫 Shooter", 2020, "Shooter", "#4da6ff"], ["Dragon Ball FighterZ", 9.8, "🥊 Pelea", 2018, "Pelea", "#ff4d4d"], ["Dragon Ball Z: Kakarot", 16.5, "⚔️ RPG", 2021, "RPG", "#a64dff"], ["Dragon Quest XI S", 13.8, "⚔️ RPG", 2019, "RPG", "#a64dff"], ["FIFA 23 / EA Sports FC 24", 30.0, "⚽ Deportes", 2023, "Deportes", "#4d4dff"], ["Fire Emblem Engage", 13.4, "⚔️ RPG", 2023, "RPG", "#a64dff"], ["Fire Emblem: Three Houses", 11.9, "⚔️ RPG", 2019, "RPG", "#a64dff"], ["Fortnite", 15.6, "🔫 Shooter", 2018, "Shooter", "#4da6ff"], ["Grand Theft Auto: The Trilogy", 20.5, "💥 Acción", 2021, "Acción", "#ffaa4d"], ["Hades", 5.8, "💀 Roguelike", 2020, "Roguelike", "#884400"], ["Hogwarts Legacy", 15.0, "🗺️ Aventura", 2023, "Aventura", "#4dff88"], ["Hollow Knight", 5.3, "🦇 Metroidvania", 2018, "Metroidvania", "#550055"], ["Inside", 1.5, "🗺️ Aventura", 2018, "Aventura", "#4dff88"], ["It Takes Two", 9.5, "🗺️ Aventura", 2022, "Aventura", "#4dff88"], ["Kirby and the Forgotten Land", 5.8, "🏃 Plataformas", 2022, "Plataformas", "#ff4da6"], ["Kirby's Return to Dream Land Deluxe", 6.2, "🏃 Plataformas", 2023, "Plataformas", "#ff4da6"], ["L.A. Noire", 27.4, "🗺️ Aventura", 2017, "Aventura", "#4dff88"], ["LEGO Star Wars: The Skywalker Saga", 14.0, "🗺️ Aventura", 2022, "Aventura", "#4dff88"], ["Limbo", 0.2, "🧩 Puzzle", 2018, "Puzzle", "#cc4dff"], ["Little Nightmares II", 7.6, "👻 Terror", 2021, "Terror", "#880000"], ["Luigi's Mansion 2 HD", 3.2, "🗺️ Aventura", 2024, "Aventura", "#4dff88"], ["Luigi's Mansion 3", 6.4, "🗺️ Aventura", 2019, "Aventura", "#4dff88"], ["Mario Kart 8 Deluxe", 12.5, "🏎️ Carreras", 2017, "Carreras", "#ffff4d"], ["Mario Party Superstars", 2.9, "🎉 Party", 2021, "Party", "#ffcc00"], ["Mario vs. Donkey Kong", 1.7, "🧩 Puzzle", 2024, "Puzzle", "#cc4dff"], ["Mega Man 11", 2.5, "🏃 Plataformas", 2018, "Plataformas", "#ff4da6"], ["Metal Gear Solid: Master Collection Vol.1", 25.0, "💥 Acción", 2023, "Acción", "#ffaa4d"], ["Metroid Dread", 4.1, "🦇 Metroidvania", 2021, "Metroidvania", "#550055"], ["Metroid Prime Remastered", 6.1, "🔫 Shooter", 2023, "Shooter", "#4da6ff"], ["Minecraft", 2.5, "🧱 Sandbox", 2017, "Sandbox", "#8b4513"], ["Monster Hunter Rise (+Sunbreak)", 18.2, "⚔️ RPG", 2021, "RPG", "#a64dff"], ["Mortal Kombat 1", 34.0, "🥊 Pelea", 2023, "Pelea", "#ff4d4d"], ["Mortal Kombat 11 (Ultimate)", 32.5, "🥊 Pelea", 2019, "Pelea", "#ff4d4d"], ["NBA 2K24", 58.0, "⚽ Deportes", 2023, "Deportes", "#4d4dff"], ["Naruto Shippuden: UNS 4 Road to Boruto", 13.2, "🥊 Pelea", 2020, "Pelea", "#ff4d4d"], ["New Super Mario Bros. U Deluxe", 2.5, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"], ["NieR: Automata", 10.9, "⚔️ RPG", 2022, "RPG", "#a64dff"], ["Nintendo Switch Sports", 3.2, "⚽ Deportes", 2022, "Deportes", "#4d4dff"], ["No Man's Sky", 5.0, "🗺️ Aventura", 2022, "Aventura", "#4dff88"], ["One Piece: Pirate Warriors 4", 15.0, "💥 Acción", 2020, "Acción", "#ffaa4d"], ["Ori and the Will of the Wisps", 4.2, "🦇 Metroidvania", 2020, "Metroidvania", "#550055"], ["Outlast 2", 9.6, "👻 Terror", 2018, "Terror", "#880000"], ["Outlast: Bundle of Terror", 5.7, "👻 Terror", 2018, "Terror", "#880000"], ["Overcooked! All You Can Eat", 8.8, "🎉 Party", 2021, "Party", "#ffcc00"], ["Overwatch 2", 23.0, "🔫 Shooter", 2019, "Shooter", "#4da6ff"], ["Paper Mario: The Thousand-Year Door", 5.1, "⚔️ RPG", 2024, "RPG", "#a64dff"], ["Persona 5 Royal", 12.5, "⚔️ RPG", 2022, "RPG", "#a64dff"], ["Pikmin 4", 10.5, "♟️ Estrategia", 2023, "Estrategia", "#008888"], ["Plants vs. Zombies: Battle for Neighborville", 6.5, "🔫 Shooter", 2021, "Shooter", "#4da6ff"], ["Pokémon Brilliant Diamond / Shining Pearl", 6.9, "⚔️ RPG", 2021, "RPG", "#a64dff"], ["Pokémon Legends: Arceus", 6.1, "⚔️ RPG", 2022, "RPG", "#a64dff"], ["Pokémon Let's Go Pikachu / Eevee", 4.2, "⚔️ RPG", 2018, "RPG", "#a64dff"], ["Pokémon Scarlet / Violet", 10.5, "⚔️ RPG", 2022, "RPG", "#a64dff"], ["Pokémon Sword / Shield", 12.8, "⚔️ RPG", 2019, "RPG", "#a64dff"], ["Prince of Persia: The Lost Crown", 6.8, "🦇 Metroidvania", 2024, "Metroidvania", "#550055"], ["Princess Peach: Showtime!", 4.7, "🗺️ Aventura", 2024, "Aventura", "#4dff88"], ["Red Dead Redemption", 11.4, "🗺️ Aventura", 2023, "Aventura", "#4dff88"], ["Resident Evil 4 (Original)", 4.0, "👻 Terror", 2019, "Terror", "#880000"], ["Resident Evil 5", 18.7, "👻 Terror", 2019, "Terror", "#880000"], ["Resident Evil 6", 17.6, "👻 Terror", 2019, "Terror", "#880000"], ["Resident Evil Revelations 1+2", 35.0, "👻 Terror", 2017, "Terror", "#880000"], ["Ring Fit Adventure", 2.8, "⚽ Deportes", 2019, "Deportes", "#4d4dff"], ["Rocket League", 21.0, "⚽ Deportes", 2017, "Deportes", "#4d4dff"], ["Sea of Stars", 3.9, "⚔️ RPG", 2023, "RPG", "#a64dff"], ["Slay the Spire", 0.5, "♟️ Estrategia", 2019, "Estrategia", "#008888"], ["Sonic Frontiers", 10.4, "🏃 Plataformas", 2022, "Plataformas", "#ff4da6"], ["South Park: Snow Day!", 9.0, "💥 Acción", 2024, "Acción", "#ffaa4d"], ["Splatoon 2", 6.1, "🔫 Shooter", 2017, "Shooter", "#4da6ff"], ["Splatoon 3", 8.2, "🔫 Shooter", 2022, "Shooter", "#4da6ff"], ["Spyro Reignited Trilogy", 15.0, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"], ["Star Wars: Battlefront Classic", 25.0, "🔫 Shooter", 2024, "Shooter", "#4da6ff"], ["Stardew Valley", 1.5, "🌱 Simulación", 2017, "Simulación", "#00ffcc"], ["Street Fighter 30th Anniversary", 5.1, "🥊 Pelea", 2018, "Pelea", "#ff4d4d"], ["Subnautica", 6.2, "🌱 Simulación", 2021, "Simulación", "#00ffcc"], ["Super Mario 3D World + Bowser's Fury", 3.0, "🏃 Plataformas", 2021, "Plataformas", "#ff4da6"], ["Super Mario Bros. Wonder", 3.6, "🏃 Plataformas", 2023, "Plataformas", "#ff4da6"], ["Super Mario Maker 2", 2.8, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"], ["Super Mario Odyssey", 5.7, "🏃 Plataformas", 2017, "Plataformas", "#ff4da6"], ["Super Mario Party", 2.7, "🎉 Party", 2018, "Party", "#ffcc00"], ["Super Mario RPG", 6.5, "⚔️ RPG", 2023, "RPG", "#a64dff"], ["Super Smash Bros. Ultimate", 17.5, "🥊 Pelea", 2018, "Pelea", "#ff4d4d"], ["Terraria", 0.4, "🧱 Sandbox", 2019, "Sandbox", "#8b4513"], ["The Binding of Isaac: Repentance", 1.8, "💀 Roguelike", 2021, "Roguelike", "#884400"], ["The Elder Scrolls V: Skyrim", 14.5, "⚔️ RPG", 2017, "RPG", "#a64dff"], ["The Legend of Zelda: Breath of the Wild", 16.0, "🗺️ Aventura", 2017, "Aventura", "#4dff88"], ["The Legend of Zelda: Tears of the Kingdom", 16.3, "🗺️ Aventura", 2023, "Aventura", "#4dff88"], ["The Witcher 3: Wild Hunt (Complete)", 32.5, "⚔️ RPG", 2019, "RPG", "#a64dff"], ["Tomb Raider I-III Remastered", 5.0, "🗺️ Aventura", 2024, "Aventura", "#4dff88"], ["Tunic", 2.8, "🗺️ Aventura", 2022, "Aventura", "#4dff88"], ["Undertale", 0.3, "⚔️ RPG", 2018, "RPG", "#a64dff"], ["Unicorn Overlord", 6.5, "⚔️ RPG", 2024, "RPG", "#a64dff"], ["Vampire Survivors", 0.4, "💀 Roguelike", 2023, "Roguelike", "#884400"], ["Warframe", 19.5, "🔫 Shooter", 2018, "Shooter", "#4da6ff"], ["Wolfenstein II: The New Colossus", 23.0, "🔫 Shooter", 2018, "Shooter", "#4da6ff"], ["Xenoblade Chronicles 2", 13.2, "⚔️ RPG", 2017, "RPG", "#a64dff"], ["Xenoblade Chronicles 3", 15.0, "⚔️ RPG", 2022, "RPG", "#a64dff"], ["Xenoblade Chronicles: Definitive Edition", 13.7, "⚔️ RPG", 2020, "RPG", "#a64dff"], ["Yoshi's Crafted World", 5.3, "🏃 Plataformas", 2019, "Plataformas", "#ff4da6"]];
const CATEGORIES = ["Acción", "Aventura", "Carreras", "Deportes", "Estrategia", "Metroidvania", "Party", "Pelea", "Plataformas", "Puzzle", "RPG", "Roguelike", "Sandbox", "Shooter", "Simulación", "Terror"];
...
function updateSDCapacity() {
    updateStats(); 
    applyFilters(); // Re-render to check space limits
}
...
function renderGames(list) {
    ...
    container.innerHTML = list.map((g, index) => {
        ...
        // Logic: If NOT selected, check if it fits. If it doesn't fit, add .no-space class
        let noSpaceClass = "";
...
function toggleGame(name) {
    ...
    applyFilters(); // Re-render to update 'no-space' status on other cards
}
